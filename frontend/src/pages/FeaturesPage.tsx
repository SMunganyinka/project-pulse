      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <div className="mt-8 flex items-center justify-center">
            ...
            <span className="ml-2 text-sm text-gray-600">Loved by 1000+ teams worldwide</span>
          </div>
        </div>
        ...
        <div className="mt-20 w-full max-w-3xl mx-auto bg-white rounded-xl p-8 shadow-lg text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="px-6 py-3 bg-indigo-600 text-white font-semibold rounded-md shadow hover:bg-indigo-700 transition flex items-center justify-center"
            >
            ...
            {!isAuthenticated && (
              <Link
                to="/login"
                className="px-6 py-3 text-indigo-600 font-semibold rounded-md border border-indigo-600 hover:bg-indigo-50 transition flex items-center justify-center"
              >
                Sign In
              </Link>
            )}
