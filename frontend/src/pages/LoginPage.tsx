        ...
        <div className="bg-white bg-opacity-90 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="relative p-6 sm:p-8 border-b border-gray-100">
            ...
            <div className="relative text-center">
              ...
              <p className="text-gray-600 text-sm sm:text-base">Sign in to access your workspace</p>
            </div>
          </div>

          <form id="login-form" onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-6">
